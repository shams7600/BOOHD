...
Kirki::add_field( 'safreen', array(
	'type'        => 'custom',
	'settings'    => 'safreen_view_link_pro',
	'section'     => 'safreen_upgradepro_options',
	'default'     => '<a class="button-error  button-upsell" target="_blank" href="' . esc_url( 'https://www.imonthemes.com/safreen-pro/' ) . '">'.esc_html__( 'Upgrade To Pro', 'safreen' ).'</a>',
	'priority'    => 10,
) );
...
Kirki::add_field( 'safreen', array(
	'type'        => 'custom',
	'settings'    => 'safreen_view_link2',
	'section'     => 'safreen_upgradepro_options',
	'default'     => '<a class="button-blue  button-upsell" target="_blank" href="' . esc_url( 'https://wordpress.org/support/theme/safreen' ) . '">'.esc_html__( 'Support', 'safreen' ).'</a>',
	'priority'    => 30,
) );
...
Kirki::add_field( 'safreen', array(
	'type'        => 'custom',
	'settings'    => 'safreen_view_link3',
	'section'     => 'safreen_upgradepro_options',
	'default'     => '<a class="button-warning  button-upsell" target="_blank" href="' . esc_url( 'http://safreen-docs.imonthemes.com/' ) . '">'.esc_html__( 'Read the documentation', 'safreen' ).'</a>',
	'priority'    => 50,
) );
